...
const horizontalPosition = "left-[var(--page-gutter)]";
...
export default function Hero() {
  return (
    ...
    >
      ...
      <div
        className={`absolute top-[45%] w-[calc(100%-44px)] -translate-y-1/2 min-[561px]:top-[50%] min-[561px]:w-[min(76vw,540px)] min-[561px]:translate-y-[-54%] min-[901px]:w-[min(42vw,620px)] ${horizontalPosition}`}
      >
      ...
      <div
        className='absolute right-[var(--page-gutter)] bottom-8.25 flex items-center gap-1.5 min-[561px]:bottom-11 min-[561px]:gap-2'
